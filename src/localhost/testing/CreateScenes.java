//Created by Daniel Kerr 6/30/17
...
public class CreateScenes {
	...
	public void createAllScenes() {
		try {
			...
			driver.findElement(By.id("scene_name")).sendKeys("ALL");
			...
			driver.findElement(By.id("btmakescene")).click();
			driver.findElement(By.id("scene_name")).sendKeys("Evens");
			driver.findElement(By.cssSelector("button.btn.btn-primary")).click();
			Thread.sleep(1000);
			...
			driver.findElement(By.id("btmakescene")).click();
			driver.findElement(By.id("scene_name")).sendKeys("Odds");
			driver.findElement(By.cssSelector("button.btn.btn-primary")).click();
			Thread.sleep(1000);
			...
			driver.findElement(By.id("btmakescene")).click();
			driver.findElement(By.id("scene_name")).sendKeys("FirstHalf");
			driver.findElement(By.cssSelector("button.btn.btn-primary")).click();
			Thread.sleep(1000);
			...
			driver.findElement(By.id("btmakescene")).click();
			driver.findElement(By.id("scene_name")).sendKeys("SecondHalf");
			driver.findElement(By.cssSelector("button.btn.btn-primary")).click();
			Thread.sleep(1000);
